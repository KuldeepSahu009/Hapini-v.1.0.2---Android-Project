...
import com.crm.pvt.hapinicrm.ui.CrmAdminChatFragment;
...
public class CrmAdminChatPreviewAdapter extends RecyclerView.Adapter<CrmAdminChatPreviewAdapter.ViewHolder> {


    ArrayList<TrackUserModel> users;
    CrmAdminChatPreviewClickCallback callback;

    public CrmAdminChatPreviewAdapter(CrmAdminChatPreviewClickCallback callback) {
        this.callback = callback;
    }

    @NonNull
    @Override
    public CrmAdminChatPreviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ChatPreviewBinding binding = ChatPreviewBinding.inflate(
                LayoutInflater.from(parent.getContext()),
                parent,
                false);
        return new CrmAdminChatPreviewAdapter.ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull CrmAdminChatPreviewAdapter.ViewHolder holder, int position) {
